...
The probability of the data $p(y)$ is also called the scaling constant, because it is a constant. It is the intergral of the likelihood over all possible values of the parameter(s) of the model.
