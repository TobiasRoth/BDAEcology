...
![(\#fig:principal)Principal components are eigenvectors of the covariance or correlation matrix](02-prerequisites_files/figure-docx/principal-1.png)
...
##                           Comp.1    Comp.2
## Standard deviation     1.2546821 0.6525127
## Proportion of Variance 0.7871136 0.2128864
## Cumulative Proportion  0.7871136 1.0000000
```
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-5-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-6-1.png)<!-- -->


## Standard deviation and standard error  

![](02-prerequisites_files/figure-docx/unnamed-chunk-7-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-8-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-9-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-11-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-13-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-15-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-17-1.png)<!-- -->



## Posterior distribution
![](02-prerequisites_files/figure-docx/unnamed-chunk-18-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-22-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-23-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-24-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-29-1.png)<!-- -->
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-31-1.png)<!-- -->
...
![(\#fig:unnamed-chunk-32)Different density functions of the F statistics](02-prerequisites_files/figure-docx/unnamed-chunk-32-1.png)
...
![(\#fig:unnamed-chunk-33)Number of stats courses students have taken before starting a PhD in relation to their feeling about statistics.](02-prerequisites_files/figure-docx/unnamed-chunk-33-1.png)
...
![(\#fig:unnamed-chunk-34)Visualisation of the total, between-group and within-group sum of squares. Points are observations; long horizontal line is the overall mean; short horizontal lines are group specific means.](02-prerequisites_files/figure-docx/unnamed-chunk-34-1.png)
...
![(\#fig:unnamed-chunk-37)Posterior distributions of the mean number of stats courses PhD students visited before starting the PhD grouped according to their feelings about statistics.](02-prerequisites_files/figure-docx/unnamed-chunk-37-1.png)
...
![](02-prerequisites_files/figure-docx/unnamed-chunk-40-1.png)<!-- -->
...
![(\#fig:unnamed-chunk-46)Estimated proportion of students that prefer flowers over wine as a birthday present among the car-free students (N) and the car owners (Y). Given are the median of the posterior distribution (circle). The bar extends between the 2.5% and 97.5% quantiles of the posterior distribution.](02-prerequisites_files/figure-docx/unnamed-chunk-46-1.png)
