...
```
## q90yrep
##                  0 0.0999999999999091                  1   1.09999999999991 
##                  8                  1                 38                  1 
##                  2                  3   3.09999999999991                  4 
##                 47                 22                  1                  7 
##                  5                  6                  7                  8 
##                  7                  1                  2                  1
```
...
```
##       1%      50%      99% 
## 3.733333 4.714286 5.857143
```

The mean age of the 10% of the fields with the highest whitethroat densities is 4.4 years in the observed data set. In the replicated data set it is between 3.73 and 5.86 years. The Bayesian p-value is 0.79. Thus, in around 79% of the replicated data sets the mean age of the 10% fields with the highest whitethroat densities was higher than the observed one (Figure \@ref(fig:agepp)).
