...
![](images/Cordulegaster_boltonii.jpg)
...
![(\#fig:assessmodelassumptions)(ref:amac)](2.07-glmm_files/figure-docx/assessmodelassumptions-1.png)
...
![(\#fig:unnamed-chunk-7)Raw data (points, jittered to reduce overlap) and estimated means with 95% compatiblity interval for data from 5 groups A-E and a binary outcome variable y (0/1). Groups A and E have only 0s.](2.07-glmm_files/figure-docx/unnamed-chunk-7-1.png)
