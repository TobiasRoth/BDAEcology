...
```{r, assessmodelassumptions, fig.cap="Diagnostic plots to assess model assumptions for mod.glmer. "}
...
par(mfrow=c(1,2,3), mar=c(3,4,1,1))
...
```{r effectplots}
# draw an effect plot from a glmer and a brm model

# partial effect of cow
range(dat$cow)
...
- Wie wäre es, wenn ich glmm mit glmer und brms fitten würde? Um den Unterschied in der Inferenz zu zeigen? fk: finde ich sehr gut! Die Inferenz sollte sich nicht unterscheiden, sonst wäre nicht so gut...
