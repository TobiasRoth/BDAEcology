...
![(\#fig:unnamed-chunk-2)Displaying (simulated) data with date on the x-axis with custom labelling. Code version 1.](1.99-furthertopics_files/figure-docx/unnamed-chunk-2-1.png)
...
![(\#fig:unnamed-chunk-3)Displaying (simulated) data with date on the x-axis with custom labelling. Code version 2.](1.99-furthertopics_files/figure-docx/unnamed-chunk-3-1.png)
