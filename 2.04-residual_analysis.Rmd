...
```{r diagplotdg, fig.cap="Standard diagnostic residual plots of a linear regression for the biomass data of D. glomerata."}
...
```{r diagplotap, fig.cap="Standard diagnostic residual plots of a linear regression for the biomass data of A. pratensis."}
...
```{r diagplotaplog, fig.cap="Standard diagnostic residual plots of a linear regression for the logarithm of the biomass data of A. pratensis."}
