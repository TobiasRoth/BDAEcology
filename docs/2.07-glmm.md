...
##  student_t(3, 0, 2.5)        sd           farm.f                      
##  student_t(3, 0, 2.5)        sd Intercept farm.f                      
##        source
##       default
##  (vectorized)
##  (vectorized)
...
## sd(Intercept)     0.54      0.15     0.25     0.84 1.00      918     1380
## 
## Population-Level Effects: 
##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## Intercept    -0.09      0.21    -0.50     0.30 1.00     2911     2443
## colsize.z     0.06      0.13    -0.20     0.32 1.00     2413     1601
## cow           0.40      0.24    -0.06     0.88 1.00     3045     2328
## dung.z       -0.15      0.12    -0.39     0.08 1.00     2871     2496
## 
