...
```{r, fig.width=4, fig.height=3.2,  fig.align='center', fig.cap='',echo=FALSE, message=FALSE}
...
```{r, fig.width=4, fig.height=2.7, fig.align='center', fig.cap='',echo=FALSE, results='hide'}
library(blmeco)
