...
Xmat <- model.matrix(~ ImplantDdaysDImplant:days, data=newdat)
...
The fitted values given in Figure 7.4, together with their uncertainty measures (compatibility intervals), take into account that we had repeated measures for each individual.
