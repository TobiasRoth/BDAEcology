...
In some studies, we would like to compare the data to a theoretical value. The theoretical value is a fixed value, e.g. calculated based on, e.g., physical, biochemical or ecological theory. The mean of the data and its statistical uncertainty is compared to the theoretical value.
