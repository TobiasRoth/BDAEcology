...
:::{#sim style="size: small; border: 2px solid grey"}
What does `sim` do?  
...
The $R^2$ and the adjusted $R^2$ measure the proportion of variance in the outcome variable $y$ that is explained by the predictors in the model. 
