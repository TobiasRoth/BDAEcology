...
![(\#fig:diagplotdg)Standard diagnostic residual plots of a linear regression for the biomass data of D. glomerata.](2.04-residual_analysis_files/figure-docx/diagplotdg-1.png)
...
![(\#fig:diagplotap)Standard diagnostic residual plots of a linear regression for the biomass data of A. pratensis.](2.04-residual_analysis_files/figure-docx/diagplotap-1.png)
...
![(\#fig:diagplotaplog)Standard diagnostic residual plots of a linear regression for the logarithm of the biomass data of A. pratensis.](2.04-residual_analysis_files/figure-docx/diagplotaplog-1.png)
